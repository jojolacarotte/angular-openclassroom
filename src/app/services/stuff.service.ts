...
export class StuffService {
  ...
  getStuff() {
    this.http.get('https://fhp0r.sse.codesandbox.io/api/stuff').subscribe(
      (stuff: Thing[]) => {
        if (stuff) {
          this.stuff = stuff;
          this.emitStuff();
  ...
  getThingById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.get('https://fhp0r.sse.codesandbox.io/api/stuff/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  createNewThing(thing: Thing) {
    return new Promise((resolve, reject) => {
      this.http.post('https://fhp0r.sse.codesandbox.io/api/stuff', thing).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  createNewThingWithFile(thing: Thing, image: File) {
    return new Promise((resolve, reject) => {
      ...
      this.http.post('https://fhp0r.sse.codesandbox.io/api/stuff', thingData).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  modifyThing(id: string, thing: Thing) {
    return new Promise((resolve, reject) => {
      this.http.put('https://fhp0r.sse.codesandbox.io/api/stuff/' + id, thing).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  modifyThingWithFile(id: string, thing: Thing, image: File | string) {
    return new Promise((resolve, reject) => {
      ...
      this.http.put('https://fhp0r.sse.codesandbox.io/api/stuff/' + id, thingData).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteThing(id: string) {
    return new Promise((resolve, reject) => {
      this.http.delete('https://fhp0r.sse.codesandbox.io/api/stuff/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
